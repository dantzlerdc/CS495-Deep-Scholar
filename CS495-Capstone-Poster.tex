...
\usepackage{graphicx}
\graphicspath{{./}{assets/figures/}{assets/branding/}{previews/}}
\usepackage{xcolor}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north east] at ($(current page.north east) + (-2cm, -1.5cm)$)
    {\includegraphics[width=20cm, keepaspectratio]{Poster-Cover.png}};
\end{tikzpicture}
  ...
  \begin{columns}[T]
    \column{0.49\linewidth}
      ...
      \includegraphics[width=\linewidth,keepaspectratio]
        {Poster-Forward-Pass.png}\\[0.15cm]
    ...
    \column{0.49\linewidth}
      ...
      \includegraphics[width=\linewidth,keepaspectratio]
        {Poster-Backward-Pass.png}\\[0.15cm]
...
\begin{block}{Contract A Result: Two Independent Models Agree}
  ...
  \includegraphics[height=14cm,keepaspectratio]
    {Poster-Option-Pricing-Results.png}\\[0.2cm]
  {\small
...
\begin{block}{Live Demo: Interactive CRR Binomial Pricing Calculator}
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]
    {Poster-Calculator-Hero.png}\\[0.15cm]
  {\small
