...
\begin{frame}{CRR Pricing Results: Model vs Market Validation}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=3.6cm,keepaspectratio}{%
  ...
  \begin{tikzpicture}
    \fill[navymid,rounded corners=4pt]
      (0,0) rectangle (\textwidth,0.80cm);
    \node[text=white,font=\scriptsize,anchor=west,
          text width=\dimexpr\textwidth-0.5cm\relax]
      at (0.25cm,0.40cm)
...
\begin{frame}{CRR Pricing Results: Numerical Convergence}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.3cm,keepaspectratio}{%
...
\begin{frame}{Cross-Model \& Backtest: Regime Detection}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.4cm,keepaspectratio}{%
