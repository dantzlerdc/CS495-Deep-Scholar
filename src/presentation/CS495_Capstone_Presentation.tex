...
\usepackage{graphicx}
\graphicspath{{./}{../../assets/figures/}{../../slides/figures/}}
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage{fontenc}
\usepackage{lmodern}
...
\begin{frame}{Contract A Result --- Two Independent Models Agree}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.85cm,keepaspectratio}{%
      \includegraphics{slide8_result.png}}
  \end{center}
...
\begin{frame}{CRR Pricing Results: Model vs Market Validation}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.85cm,keepaspectratio}{%
      \includegraphics{slide9_residual.png}}
  \end{center}
...
\begin{frame}{CRR Pricing Results: Numerical Convergence}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.85cm,keepaspectratio}{%
      \includegraphics{slide9_convergence.png}}
  \end{center}
...
\begin{frame}{CRR Pricing Results: Early Exercise Boundary}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.65cm,keepaspectratio}{%
      \includegraphics{slide9_boundary.png}}
  \end{center}
...
\begin{frame}{Cross-Model \& Backtest: L1 vs L2 Cross-Validation}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.65cm,keepaspectratio}{%
      \includegraphics{slide12_cross_val.png}}
  \end{center}
...
\begin{frame}{Cross-Model \& Backtest: Regime Detection}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.45cm,keepaspectratio}{%
      \includegraphics{slide12_regime.png}}
  \end{center}
...
\begin{frame}{Cross-Model \& Backtest: Walk-Forward Backtest}
  ...
  \begin{center}
    \adjustbox{max width=0.92\textwidth,max height=4.45cm,keepaspectratio}{%
      \includegraphics{slide12_backtest.png}}
  \end{center}
