...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {CRR-Monte-Carlo-Simulation.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {Slide11-EarlyExerciseBoundary.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {Binomial-Pricing-Calculator-Tree.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.92\linewidth,keepaspectratio]
    {crr-binomial-contractA-herding-results.png}
\end{center}
