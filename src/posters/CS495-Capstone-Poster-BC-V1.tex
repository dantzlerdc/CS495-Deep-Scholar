...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {Poster-CRR-Monte-Carlo-Simulation.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {Poster-Early-Exercise-Boundary.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.78\linewidth,keepaspectratio]
    {Poster-Binomial-Pricing-Calculator-Tree.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.92\linewidth,keepaspectratio]
    {Poster-CRR-Binomial-Contract-A-Herding-Results.png}
\end{center}
